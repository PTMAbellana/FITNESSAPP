...
public class NutritionFoodActivity5 extends AppCompatActivity {
//    private PieChart pieChart;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nutrition_food5);
//        pieChart = findViewById(R.id.pieChart);
        ...
        dialog = new Dialog(NutritionFoodActivity5.this);
        ...
        dialog2 = new Dialog(NutritionFoodActivity5.this);
    ...
    private void cancelOrder() {
        UpdateData.deleteDietPlan("Baked Salmon", String.valueOf(user_id));
    }
    ...
    private void calculateAndDisplayRatio() {
        ...
        if (checkBox1.isChecked()) {
            calories[0] = 200.1f * multiplier;
            totalCalories += calories[0];
        }
        if (checkBox2.isChecked()) {
            calories[1] = 5.1f * multiplier;
            totalCalories += calories[1];
        }
        if (checkBox3.isChecked()) {
            calories[2] = 5.1f * multiplier;
...
//        pieChart.invalidate(); // refresh
    ...
    public void placeOrder(){
        ...
        InsertData.insertDiet(String.valueOf(user_id), bmi_cat, "Baked Salmon");
    }
