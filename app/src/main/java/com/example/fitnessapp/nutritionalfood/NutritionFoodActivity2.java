...
//        pieChart = findViewById(R.id.pieChart);
        ...
        dialog2 = new Dialog(NutritionFoodActivity2.this);
    ...
    private void cancelOrder() {
        UpdateData.deleteDietPlan("Fruit Smoothie", String.valueOf(user_id));
    ...
    private void calculateAndDisplayRatio() {
        ...
        if (checkBox1.isChecked()) {
            calories[0] = 54.0f * multiplier;
            totalCalories += calories[0];
        }
        if (checkBox2.isChecked()) {
            calories[1] = 50.0f * multiplier;
            totalCalories += calories[1];
        }
        if (checkBox3.isChecked()) {
            calories[2] = 39.0f * multiplier;
            totalCalories += calories[2];
        }
        if (checkBox4.isChecked()) {
            calories[3] = 0.0f * multiplier;
...
//        pieChart.invalidate(); // refresh
    ...
    public void placeOrder(){
        ...
        InsertData.insertDiet(String.valueOf(user_id), bmi_cat, "Fruit Smoothie");
    }
