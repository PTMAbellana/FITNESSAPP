...
//        pieChart = findViewById(R.id.pieChart);
        ...
        dialog = new Dialog(NutritionFoodActivity7.this);
        ...
        dialog2 = new Dialog(NutritionFoodActivity7.this);
    ...
    private void cancelOrder() {
        UpdateData.deleteDietPlan("Spinach And Tomato Omelette", String.valueOf(user_id));
    }
...
//        pieChart.invalidate(); // refresh
    ...
    public void placeOrder(){
        ...
        InsertData.insertDiet(String.valueOf(user_id), bmi_cat, "Spinach And Tomato Omelette");
    }
